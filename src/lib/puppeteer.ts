import puppeteer, { Browser, ClickOptions, HTTPResponse, Page, PuppeteerLaunchOptions } from 'puppeteer'
import { wait } from '../util.js'

let _browser: Browser | null = null

const disconnectListener = (): void => console.warn('Browser has been disconnected')

export const browser = async (useBrowser: Browser | null = null): Promise<Browser> => {
  if (_browser) {
    return _browser
  }
...
export const waitAndClick = async (page: Page, selector: string, options: ClickOptions = {}): Promise<void> => {
